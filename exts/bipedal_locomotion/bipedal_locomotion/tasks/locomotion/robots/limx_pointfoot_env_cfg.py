...
from bipedal_locomotion.tasks.locomotion.cfg.PF.limx_pim_base_env_cfg import PFPIMBaseEnvCfg, PFPIMBaseEnvCfg_PLAY
...
class PFBlindStairEnvCfg(PFBaseEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.commands.base_velocity.ranges.lin_vel_x = (0.0, 1.0)      # 前进速度：0.5-1.0 m/s / Forward velocity: 0.5-1.0 m/s
        ...
        self.rewards.rew_lin_vel_xy.weight = 2.5          # 增加线速度跟踪奖励 / Increase linear velocity tracking reward
        ...
        self.rewards.pen_base_height.weight = 0.0
...
class PFBlindStairEnvCfg_PLAY(PFBaseEnvCfg_PLAY):
    ...
    def __post_init__(self):
        ...
        self.commands.base_velocity.ranges.lin_vel_x = (0.0, 1.0)    # 固定前进速度范围 / Fixed forward velocity range
...
class PFStairEnvCfgv1(PFBaseEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.rew_ang_vel_z.weight = 1.5           # 增加角速度跟踪奖励 / Increase angular velocity tracking reward
        self.rewards.pen_lin_vel_z.weight = -1.0 # -1.0 ！！！！！！！！！！！
...
class PFHIMEnvCfg(PFHIMBaseEnvCfg):
    def __post_init__(self):
        ...
        # Weight: -0.2
        self.rewards.pen_flat_orientation.weight = -1.0
        ...
        # For bipedal robot
        self.rewards.test_gait_reward.weight = 0.4 # Stable gait penalty !!!
